...
## User Story 2: Public Health Infrastructure Analyst

::: {.callout-note appearance="minimal"}
**Ruwan Dissanayake** | Age 42 | Public Health Infrastructure Analyst  
Ministry of Health, Health Infrastructure Planning Division, Colombo, Sri Lanka  
BSc in Public Health | Postgraduate Qualification in Health Systems Management
:::

### Responsibilities

- Assess the spatial adequacy of healthcare facilities including hospitals, clinics, and
pharmacies across Colombo district.
- Advise on the placement of new primary healthcare facilities to address demographic
and geographic service gaps.
- Monitor healthcare access equity across different population groups including children,
elderly and working-age adults.
- Collaborate with local authorities to align healthcare facility planning with urban
development strategies.

### Experiences

- Has a strong background in healthcare access analysis and equity assessments at
administrative unit level.
- Previously led district-level audits to identify underserved communities in the
Western Province.
- Experienced in working with census data to understand population-facility ratios
across administrative boundaries.

### Challenges

- Difficulty identifying whether low healthcare facility counts in certain GNDs reflect a
genuine service gap or simply low population demand.
- Limited understanding of how demographic structure, particularly the proportion of
young or elderly residents, relates to the spatial pattern of healthcare provision.
- Existing facility audits do not account for spatial autocorrelation, meaning nearby
GNDs influence each other in ways that standard reports fail to capture.

### Goals

- Pinpoint GNDs where healthcare facilities per 1000 people are critically low, especially
in areas with high proportions of young residents where a demographic mismatch has
been identified.
- Use spatial regression evidence to advocate for targeted clinic and pharmacy
placements in road-accessible but currently underserved GNDs.
- Ensure healthcare infrastructure planning in Colombo reflects actual population need
rather than historical facility distribution patterns.
